...
fun DependencyHandler.addLifeCycle(configurationName: String = "implementation") {
    ...
    add(configurationName, Lifecycle.viewModelCompose)
}
...
fun DependencyHandler.addCompose(configurationName: String = "implementation"){
    add(configurationName, Composes.runtime)
    add(configurationName, Composes.ui)
    add(configurationName, Composes.foundation)
    add(configurationName, Composes.foundationLayout)
    add(configurationName, Composes.material)
    add(configurationName, Composes.runtimeLivedata)
    add(configurationName, Composes.toolingPreview)
    add(configurationName, Composes.uiTooling)
    add(configurationName, Composes.activityCompose)
    add(configurationName, Composes.material3)
    add(configurationName, Composes.materialIcons)
}